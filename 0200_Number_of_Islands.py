      ...
      for j, chunk in enumerate(row):
        if chunk == "1" and (i, j) not in done:
          ...
          while stack:
            ...
            if (
              curr_j > 0
              and (curr_i, curr_j - 1) not in done
              and (curr_i, curr_j - 1) not in stack
              and grid[curr_i][curr_j - 1] == "1"
            ):
              stack.append((curr_i, curr_j - 1))
            # right
            if (
              curr_j < row_length_zero_based
              and (curr_i, curr_j + 1) not in done
              and (curr_i, curr_j + 1) not in stack
              and grid[curr_i][curr_j + 1] == "1"
            ):
            ...
            if (
              curr_i > 0
              and (curr_i - 1, curr_j) not in done
              and (curr_i - 1, curr_j) not in stack
              and grid[curr_i - 1][curr_j] == "1"
            ):
              stack.append((curr_i - 1, curr_j))
            # down
            if (
              curr_i < n_rows_0_based
              and (curr_i + 1, curr_j) not in done
              and (curr_i + 1, curr_j) not in stack
              and grid[curr_i + 1][curr_j] == "1"
            ):
      ...
      while q:
        ...
        for d1, d2 in directions:
          ...
          if (
            ...
            and (curr_row, curr_col) not in done
          ):
